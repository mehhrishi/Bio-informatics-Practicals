#Practical 2
# Write a Pyhton/Java code to find the identity value of a given sequences.Take the sequences from user.
...
se1=input("Enter the first sequences::")
se2=input("Enter the second sequences::")
